...
<!--
# nf-core/buggybarcodes bug report
...
- [ ] [nf-core/buggybarcodes pipeline documentation](https://nf-co.re/buggybarcodes/usage)
...
- version: <!-- [e.g. 1.0.0] -->
- Image tag: <!-- [e.g. nfcore/buggybarcodes:1.0.0] -->
